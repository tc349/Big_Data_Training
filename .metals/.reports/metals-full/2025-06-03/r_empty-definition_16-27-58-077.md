error id: file:///C:/Users/Om%20Parkash/Downloads/Big%20Data%20Training/Big%20Data%20Training/Spark/Scala/src/transformation.scala:`<none>`.
...
object ScalaSparkExercise {
    def main(args: Array[String]): Unit = {
		...
		.master("local[*]")    // use all cores, change to "yarn" for cluster mode if o@@n EMR/EC2
		.getOrCreate()
